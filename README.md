...
![Course Banner](https://img.shields.io/badge/Course-Cybersecurity%20%26%20Penetration%20Testing-red?style=for-the-badge&logo=hackthebox)
![License](https://img.shields.io/badge/License-Educational%20Use-green?style=for-the-badge&logo=creativecommons)
![Language](https://img.shields.io/badge/Language-Bahasa%20Indonesia-blue?style=for-the-badge&logo=googletranslate)
![Author](https://img.shields.io/badge/Original%20Content-Sekiya-purple?style=for-the-badge&logo=github)
![Compiler](https://img.shields.io/badge/Compiled%20by-Tamas-orange?style=for-the-badge&logo=markdown)
...
graph TD
    ...
    A1[Passive Info Gathering] --> A
    A2[Active Scanning] --> A
    A3[Social Engineering] --> A

    B1[Payload Creation] --> B
    B2[Exploit Development] --> B
    B3[Tool Customization] --> B

    C1[Phishing] --> C
    C2[Web Delivery] --> C
    C3[Physical Access] --> C

    D1[Buffer Overflow] --> D
    D2[SQL Injection] --> D
    D3[Code Execution] --> D

    E1[Backdoor Installation] --> E
    E2[Persistence Mechanisms] --> E
    E3[Privilege Escalation] --> E

    F1[Reverse Shell] --> F
    F2[C2 Communication] --> F
    F3[Encrypted Channels] --> F

    G1[Data Exfiltration] --> G
    G2[System Compromise] --> G
    G3[Lateral Movement] --> G
```
